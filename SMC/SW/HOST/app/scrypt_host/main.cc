...
int main(int argc, char *argv[])
{
    ...
    ____TIME_STAMP(0);
    ret = crypto_scrypt(password, strlen(password_char), salt, strlen(salt_char), CPU_MEM_COST, BLOCK_SIZE_PARAM, PARALLEL_PARAM, kbuf, 64);
    ____TIME_STAMP(1);
    if (ret != 0) {
