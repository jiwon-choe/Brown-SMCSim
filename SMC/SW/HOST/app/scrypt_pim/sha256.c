...
static void SHA256_Transform(uint32_t *state,
    const uint8_t *block, uint32_t *W, uint32_t *S);
 ...
 */
static void
_SHA256_Final(uint8_t *digest, SHA256_CTX * ctx,
    uint32_t *tmp32)
    /* digest[32], tmp32[72] */
{
...
/* Wrapper function for intermediate-values sanitization. */
void
SHA256_Final(uint8_t *digest, SHA256_CTX * ctx)
    /* digest[32] */
{
	uint32_t tmp32[72];
 ...
 */
void
SHA256_Buf(const void * in, size_t len, uint8_t *digest)
    /* digest[32] */
{
	SHA256_CTX ctx;
	uint32_t tmp32[72];
...
_HMAC_SHA256_Init(HMAC_SHA256_CTX * ctx, const void * _K, size_t Klen,
    uint32_t *tmp32, uint8_t *pad, uint8_t *khash)
{
 ...
 */
static void
_HMAC_SHA256_Final(uint8_t *digest, HMAC_SHA256_CTX * ctx,
    uint32_t *tmp32, uint8_t *ihash)
    /* digest[32], tmp32[72], ihash[32] */
{
...
/* Wrapper function for intermediate-values sanitization. */
void
HMAC_SHA256_Final(uint8_t *digest, HMAC_SHA256_CTX * ctx)
    /* digest[32] */
{
	uint32_t tmp32[72];
	uint8_t ihash[32];
