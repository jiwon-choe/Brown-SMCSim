...
do
	...
	export OFFLOADED_KERNEL_NAME=dgraph_teenage_follower_dma2	# Kernel name to offload (Look in SMC/SW/PIM/kernels)
	
	#####################
	export OFFLOADED_GRAPH_NODES=1024			# Number of nodes
	export OFFLOADED_GRAPH_DENSITY=$V0		# Connection density (percentage)
